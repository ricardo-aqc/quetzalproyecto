    ...
    <header>
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid row row-cols-auto">
                <a style="color:white; font-family:'Roboto'; font-size:xx-large" class="navbar-brand col-4" href="#"><img src="img\Quetzal.jpg" class="logo" alt=""></a>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col">
                                <div class="card-body">
                                    <center>
                                        <p>
                                            Excelente ubicación en el corredor comercial Carretera al Tejar ideal para

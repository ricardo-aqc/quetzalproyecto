...
<body>
    ...
    <main>
        <div class="contain col-2" style="padding:1%">
            <a href="Obras.php"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
        ...
        <center>
            <div>
                <h1 class="h1" style="text-decoration:underline; color:black; font-family:'Roboto'">

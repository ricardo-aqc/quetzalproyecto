                    ...
                    <div class="row">
                        ...
                        <div class="text-center">
                            <input type="text" class="form-control" id="nameInput" placeholder="" required
                                value="Proyecto Remodelación Morrones Prieto" pattern="[a-zA-Z ]+" />
                        </div>
                    </div>
                    <div class="row">
                        <label for="nameInput" class="form-label">Descripción del Proyecto</label>
                        <div class="text-center">
                            <textarea class="form-control" id="nameInput" rows="6">
Un proyecto de remodelación de una casa que se encuentra dentro del area de Morones prieto 
Medidas:  125 metros cuadrados</textarea>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="text-center">
                            <input type="text" class="form-control" id="lastNameInput" placeholder="" required
                                pattern="[a-zA-Z]+"
                                value="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3596.065036933676!2d-100.43140652509422!3d25.66913871242464!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x866297fd33931237%3A0xefc1896f57355833!2sMorones%20Prieto%2C%20La%20Fama%2C%2066100%20Santa%20Catarina%2C%20N.L.!5e0!3m2!1ses!2smx!4v1699308549453!5m2!1ses!2smx" />
                        </div>
                    </div>
                    <div class="row mb-3">

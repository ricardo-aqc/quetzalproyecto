...
<body>
    ...
    <div class="aboutus-area">
        <div class="container mt-5 mb-5">
            <div class="row">
                <div class="col-xs-12">
                    <img src="https://jezzmedia.com/wp-content/uploads/2022/10/mision-vision-y-valores-6.jpg" class="rounded float-end" style="width: 400px" alt="...">
                    <div class="col-md-8 col-sm-6 col-xs-12">
                        <div class="aboutus-content ">
                            <h1>Nuestra <span>Misión</span></h1>

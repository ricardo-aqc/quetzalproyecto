    ...
    <main>
        ...
        <div class="contain">
            <div class="row">
                ...
                <?php
                $sql = "SELECT * FROM obra_imagen INNER JOIN imagen ON obra_imagen.imagen_id=imagen.imagen_id  INNER JOIN obra on obra_imagen.obra_id = obra.obra_id";
                ...
                <div class="col-4 align-items-stretch">
                    ...
                    <div class="card-body">
                        <?php
                            echo '<a class="btn card-title d-flex justify-content-center" name="redirBtn" data-id="1"  >' . $row["nombre"] . '  </a>'
                            ?>
            ...
            <div class="row">
                <div class="col-4 align-items-stretch">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a href="ObraInfo.php">
                                <h5 class="card-title d-flex justify-content-center" style="font-size:x-large"> Opcion 1
                                </h5>
                            </a>
                            <p class="card-text" style="text-decoration:underline"></p>
                        </div>
                ...
                <div class="col-4 align-items-stretch">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a href="ObraInfo.php">
                                <h5 class="card-title d-flex justify-content-center" name style="font-size:x-large">
                                    Opcion 1
                                </h5>
                            </a>
                            <p class="card-text" style="text-decoration:underline"></p>
...
<script>
const buttonsEdit = document.getElementsByName("redirBtn");
buttonsEdit.forEach(function(button) {
    button.addEventListener('click', function() {

        let name = $(this).text();

        window.location.href = "obrainfo.php?name=" + name;
        // window.location.href = "editarobra.php?id=" + $(this).closest("tr").index();
    });
});
</script>
